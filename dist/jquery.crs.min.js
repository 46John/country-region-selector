...
$("."+a).each(i)},i=function(){var a=this,c=a.getAttribute("data-crs-loaded");if("true"!==c){a.length=0;var e=$(a).attr("data-default-option"),g=e?e:b,h=a.getAttribute("data-show-default-option");d=null===h?!0:"true"===h;var i=$(a).attr("data-default-value"),l=$(a).attr("data-value"),p=0;d&&(this.options[0]=new Option(g,"")),k({whitelist:a.getAttribute("data-whitelist"),blacklist:a.getAttribute("data-blacklist")});for(var q=0;q<f.length;q++){var r="shortcode"==l||"2-char"===l?f[q][1]:f[q][0];a.options[a.length]=new Option(f[q][0],r),null!=i&&i===r&&(p=q,d&&p++)}this.selectedIndex=p;var s=$(a).attr("data-region-id");if(!s)return void console.error("Missing data-region-id on country-region-selector country field.");var t=$("#"+s)[0];if(t)if(j(t),$(this).on("change",function(){o(a,t)}),i&&a.selectedIndex>0){o(a,t);var u=m(t),v="shortcode"===t.getAttribute("data-value");if(null!==u)for(var w=d?a.selectedIndex-1:a.selectedIndex,x=f[w][3],y=0,z=u.length;z>y;y+=1)n(t,x,u[y],v)}else d===!1&&o(a,t);else console.error("Region dropdown DOM node with ID "+s+" not found.");a.setAttribute("data-crs-loaded","true")}},j=function(a){var b=$(a).attr("data-blank-option"),c=b?b:"-",d=!a.multiple&&a.getAttribute("data-show-default-option");e=null===d?!0:"true"===d,a.length=0,e&&(a.options[0]=new Option(c,""),a.selectedIndex=0)},k=function(a){var b=g,c=[],d=0;if(a.whitelist){var e=a.whitelist.split(",");for(d=0;d<g.length;d++)-1!==e.indexOf(g[d][1])&&c.push(g[d]);b=c}else if(a.blacklist){var h=a.blacklist.split(",");for(d=0;d<g.length;d++)-1===h.indexOf(g[d][1])&&c.push(g[d]);b=c}f=b,l()},l=function(){for(var a=0;a<f.length;a++){for(var b={hasShortcodes:/~/.test(f[a][2]),regions:[]},c=f[a][2].split("|"),d=0;d<c.length;d++){var e=c[d].split("~");b.regions.push([e[0],e[1]])}f[a][3]=b}},m=function(a){var b;return(b=$(a).attr("data-default-values"))?b.split(","):(b=$(a).attr("data-default-value"))?[b]:void 0},n=function(a,b,c,d){for(var f,g=!a.multiple&&e,h=0;h<b.regions.length;h++){var i=d&&b.hasShortcodes&&b.regions[h][1]?b.regions[h][1]:b.regions[h][0];if(i===c){f=g?h+1:h,a.options[f].selected="selected";break}}},o=function(a,b){var g=d?a.selectedIndex-1:a.selectedIndex,h=$(b).attr("data-default-option"),i=b.getAttribute("data-value"),k=h?h:c;if(""===a.value)j(b);else{b.length=0,e&&(b.options[0]=new Option(k,""));for(var l=f[g][3],m=0;m<l.regions.length;m++){var n="shortcode"===i&&l.hasShortcodes?l.regions[m][1]:l.regions[m][0];b.options[b.length]=new Option(l.regions[m][0],n)}b.multiple||(b.selectedIndex=0)}};return $(h),{init:h}});